...
package net.play5d.game.obvn.fighter {
	...
	public class Bullet implements IGameSprite {
		...
		public var speedLevel:Number = 0;
		...
		public function getHitVO():HitVO {
			return _hitVO;
		}
		...
		public function render():void {
			...
			mc.x += speed.x * _speedPlus * (1 - speedLevel);
		...
		private function doHit():void {
			if (!_isHit && MCUtils.hasFrameLabel(mc, "hit")) {
				mc.gotoAndStop("hit");
			}

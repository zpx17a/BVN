...
package net.play5d.game.obvn.fighter.ctrler {
	...
	public class AssisterCtrler {
		...
		public var hitOwnerChecker:String;
		private var _touchSideAction:String;
		
		public function get effect():FighterEffectCtrler {
		...
		public function finish(showEffect:Boolean = true):void {
			if (showEffect) {
				EffectCtrler.I.assisterEffect(_assister);
			}
		...
		public function initAssister(assister:Assister):void {
			...
			_effectCtrler = new FighterEffectCtrler(assister);
		}
		...
		public function getAttacker(name:String):FighterAttackerCtrler {
			var attacker:FighterAttacker = GameCtrler.I.getAttacker(name, _assister.team.id);
			if (attacker != null) {
		...
		public function isBullet(sp:IGameSprite):Boolean {
			return sp is Bullet;
		}
		
		public function getGameSprites():Vector.<IGameSprite> {
			var gameStage:GameStage = GameCtrler.I.gameStage;
			
			if (!gameStage) {
				return null;
			}
			
			return gameStage.getGameSprites();
		}
	}
}

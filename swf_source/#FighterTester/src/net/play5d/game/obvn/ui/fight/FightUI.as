...
package net.play5d.game.obvn.ui.fight {
	...
	public class FightUI implements IGameUI {
		...
		public function render():void {
			...
			var zoom:Number = GameCtrler.I.gameStage.camera.getZoom();
...
//		}
		...
		public function showStart(finishBack:Function = null, params:Object = null):void {
			...
			var round:int = GameCtrler.I.gameRunData.round;
		...
		public function showEnd(finishBack:Function = null, params:Object = null):void {
			...
			if (GameCtrler.I.gameRunData.isTimerOver) {
				playTimeOver();
			}
			else {
		...
		private function playKO(loser:FighterMain = null):void {
			_showWinnerDelay = 0;
			EffectCtrler.I.freezeEnabled = false;
			_isSlowDown = false;
			
			if (loser) {
				EffectCtrler.I.doEffectById("hit_end", loser.x, loser.y);
				EffectCtrler.I.shine(0xFFFFFF, 0.5);
				
				GameCtrler.I.gameStage.cameraFocusOne(loser.getDisplay());
			}
			...
			if (p1 && p2) {
				...
				{
					bsKO = true;
					EffectCtrler.I.BGEffect("kobg", 2);
				}
			}
			
			EffectCtrler.I.shake(5, 0, 1.5);
			SoundCtrler.I.playSwcSound(snd_over_hit);
			...
			function playKO2():void {
				...
				SoundCtrler.I.playSwcSound(bsKO ? snd_ko_bs : snd_ko);
		...
		private function koBack(e:Event):void {
			EffectCtrler.I.freezeEnabled = true;
		...
		private function renderEnd():void {
			...
			if (_showWinnerDelay > 0) {
				...
				if (_showWinnerDelay <= 0) {
					...
					if (winner) {
						GameCtrler.I.gameStage.cameraFocusOne(winner.getDisplay());
						
						showWinner(winner);
						
						if (GameMode.isSingleMode()) {
							showWins(winner, GameCtrler.I.gameRunData.getWins(winner));
						}
		...
		private static function getPlayerPos(sp:IGameSprite):Point {
			var pos:Point = GameCtrler.I.gameStage.getGameSpriteGlobalPosition(sp, 0, -50);

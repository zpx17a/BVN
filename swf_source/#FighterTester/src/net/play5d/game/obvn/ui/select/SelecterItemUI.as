...
package net.play5d.game.obvn.ui.select {
	...
	public class SelecterItemUI {
		...
		public var currentSelectFighterItem:SelectFighterItem;
...
//		}
		...
		public function changeMore(back:Function = null):void {
			if (currentSelectFighterItem.hasMore) {
				currentFighter = currentSelectFighterItem.changeMore();
